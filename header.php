...
<head>
	...
	<?php if (is_single()) { ?>
		...
		<meta property="twitter:site" content="@getsurfapp"> 
		...
		<meta property="twitter:creator" content="@getsurfapp"> 
...
<header>
	<nav class="navigation">
		<div class="logo"><a href="#fbsection1"><img src="<?php echo bloginfo('template_directory'); ?>/assets/images/logo_icon.svg" alt="SURF"></a></div>
		<ul>
			<li><a href="#fbsection1">About</a></li>
			<li><a href="#fbsection2">Features</a></li>
			<li><a href="#fbsection3">Process</a></li>
			<li><a href="#fbsection4">Artists</a></li>
